...
This repository contains the supplementary documentation and data for the article *Detecting effective and malfunctional teaching practices in student evaluations using LLMs*. The first section outlines the teaching practices extracted from previous literature, providing detailed descriptions for each practice along with the original sources cited by our primary references. The second section relates to the student feedback dataset (Herath et al., 2022) and provides the resulting dataset from our teaching practice annotation process. This annotation process served as the foundation for the E-MIRT models used for construct validation, which is the focus of the subsequent section detailing the correlation matrices between the latent traits presented in the manuscript. Derived from this analysis is our developed teaching practices coding instrument, presented in two versions: an extended version containing all 44 practices validated by the expert panel, and a short version featuring the 21 practices that successfully passed construct validation. Finally, regarding the classification experiments using Large Language Models (LLMs), this repository provides the specific prompts used for each inference approach alongside the inference datasets generated by all evaluated models.


**Content:**
* [Description of extracted teaching practices from prior research](https://github.com/studentcommentspaper/supplementary_materials/#Description-of-extracted-teaching-practices-from-prior-research)
* [Instrument for Teaching Practices Analysis](https://github.com/studentcommentspaper/supplementary_materials/#Instrument-for-Teaching-Practices-Analysis)
* [Dataset and human annotation of teaching practices](https://github.com/studentcommentspaper/supplementary_materials/#Dataset-and-human-annotation-of-teaching-practices)
* [Exploratory-Multidimensional Item Response Theory Models](https://github.com/studentcommentspaper/supplementary_materials/#Exploratory-Multidimensional-Item-Response-Theory-Models)
* [Instrument](https://github.com/studentcommentspaper/supplementary_materials/#Instrument)
* [Classification experiments with LLMs](https://github.com/studentcommentspaper/supplementary_materials/#Classification-experiments-with-LLMs)
...
## Dataset and human annotation of teaching practices
...
## Exploratory-Multidimensional Item Response Theory Models

### Correlations among latent traits of E-MIRT models for effective teaching practices
...
### Correlations among latent traits of E-MIRT models for malfunctional teaching practices
...
The experiments used four models: **Kimi-k2 32B, Qwen3.2 32B, Llama3.1 70B,** and **GPT-OSS 120B**; which were evaluated across three inference approaches: Zero-Shot, Few-Shot, and a Multi-Agent System (MAS). Datasets with models inferences are organized by inference approach: 
